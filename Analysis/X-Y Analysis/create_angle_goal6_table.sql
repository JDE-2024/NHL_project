...
--);
INSERT INTO angle_goal6 (group_angle, event, type, count_type, count_event, total_goals, percentage_of_type, percentage_of_goal_types, percent_index)
WITH YY AS(
